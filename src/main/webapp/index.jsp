...
<head>
    ...
    <title>sanjodevopsproject</title>


    <!-- Custom styles for this template -->
    <link href="sanjo.css" rel="stylesheet">
...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">sanjo DevOps AWS Lab</a>
        </div>
